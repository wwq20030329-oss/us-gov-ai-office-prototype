...
### Next Slice
把 `Sessions / Departments / Office / Dashboard` 围绕同一条**任务流转链**再收紧一轮：
- 在 Sessions 中继续增强流程阶段信息与任务摘要
- 在 Departments 中补“当前职责位置 / 最近处理阶段”
- 在 Dashboard 中把“近期活跃机构”继续朝“事项流转看板”推进
- 必要时新增一个轻量的任务流程组件，统一复用
